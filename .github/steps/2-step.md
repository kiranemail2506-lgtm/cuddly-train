...
1. Observe how Copilot references the general project instructions and the assignment specific instruction files.
   ...
   <img width="600" alt="screenshot of Copilot chat showing attached references" src="https://github.com/kiranemail2506-lgtm/cuddly-train/blob/main/.github/images/copilot-chat-reviews-instructions.png?raw=true" />
